<!-- wp:mailster/form-wrapper {"background":{"opacity":100,"fixed":false,"repeat":false,"size":"cover","image":"https://static.mailster.co/forms/tropical-leaves.jpg","fullscreen":true,"position":{"x":0.51,"y":0.35}},"css":{"general":".mailster-block-form{\n    max-width:500px;\n}\n.mailster-wrapper{\n\tmargin-top:0.5em\n}\n.mailster-wrapper-required label.mailster-label::after{\n    display:none\n}\n\n","tablet":"","mobile":""}} -->
...
<h2 class="wp-block-heading" style="font-size:45px;font-style:normal;font-weight:700;letter-spacing:-0.1rem">Here is your 20% discount.</h2>
<!-- /wp:heading -->
