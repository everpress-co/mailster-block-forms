...
<h2 style="font-size:45px;letter-spacing:-0.1rem">Here is your 20% discount.</h2>
<!-- /wp:heading -->
...
<!-- wp:mailster/field-email {"id":"b10cde","inline":true,"style":{"width":57}} -->
<div class="wp-block-mailster-field-email mailster-wrapper mailster-wrapper-required mailster-wrapper-type-email mailster-wrapper-inline mailster-wrapper-asterisk" style="width:57%"><input name="email" id="mailster-input-b10cde" type="email" aria-required="true" aria-label="Your Email address" spellcheck="false" required value="" class="input" autocomplete="email" placeholder=" "/><label for="mailster-input-b10cde" class="mailster-label">Your Email address</label></div>
