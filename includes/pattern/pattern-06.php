...
<h2 class="alignfull has-text-align-left has-text-color" style="color:#ffffff;font-style:normal;font-weight:900">Subscribe to our Newsletter!</h2>
<!-- /wp:heading -->
...
<!-- wp:mailster/field-submit {"id":"e4edc9","style":{"width":33},"className":"mailster-wrapper-asterisk"} -->
<div class="wp-block-mailster-field-submit mailster-wrapper mailster-wrapper-type-submit wp-block-button mailster-wrapper-asterisk" style="width:33%"><input name="submit" id="mailster-input-e4edc9" type="submit" value="Subscribe" class="wp-block-button__link submit-button"/></div>
